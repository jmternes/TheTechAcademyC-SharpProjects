...
namespace Casino.Blackjack
{
    public class BlackjackGame : Game, IWalkAway
    {
        ...
        public override void Play()
        {
            ...
            foreach (Player player in Players)
            {
                ...
                while (!validAnswer)
                {
                    ...
                    if (!validAnswer) Console.WriteLine("Please enter a numerical value, with no decimals.");
                }
                if (bet < 0)
                {
                    throw new FraudException("Security! WeeWoo");
                }
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                if (i == 1)
                {
                    ...
                    if (blackJack)
                    {
                        Console.WriteLine("Dealer has blackjack! Everyone loses! Except me >:)");
        ...
        // implementation of interface IWalkAway
